...
function PostArticle() {
  ...
  const handleSubmit = (e) => {
    ...
    // fetch("https://your-server-url.com/articles", {
    //   method: "POST",
    //   headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6 bg-base-200 rounded-2xl shadow-xl my-10 text-black">
      <h2 className="text-3xl font-bold text-center mb-6">Post a New Article</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="form-control">
          ...
          <input type="text" name="tags" className="input input-bordered" />
        </div>

        <div className="form-control">
          <label className="label font-semibold">Thumbnail Image URL</label>
          <input type="url" name="thumbnail" className="input input-bordered" required />
        </div>
